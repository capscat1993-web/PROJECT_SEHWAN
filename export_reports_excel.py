...
def main() -> int:
    ...
    parser.add_argument("--db", default="reports.db", help="reports.db path (default: reports.db)")
    parser.add_argument("--out", default="reports_by_company.xlsx", help="Output xlsx (default: reports_by_company.xlsx)")
